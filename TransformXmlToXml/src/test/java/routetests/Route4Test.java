...
public class Route4Test extends CamelTestSupport {
    ...
    public void setUp() throws Exception{
        ...
        RouteDefinition route4Definition = context.getRouteDefinition("route4");


        route4Definition.adviceWith(context, new AdviceWithRouteBuilder() {
            @Override
    ...
    @Test
    public void route4_whenValidInput_thenValidOutput() throws Exception{
        // reading in xml request and expected with some
        String request = FileUtils.readFileToString(ResourceUtils.getFile("classpath:input/request4.xml"));
        String expected = FileUtils.readFileToString(ResourceUtils.getFile("classpath:expected/expectedResultRoute4.xml"));
